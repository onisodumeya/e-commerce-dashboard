...
function Sidebar() {
  ...
  return (
    <nav className="hidden lg:flex flex-col w-1/5 items-start justify-between gap-3 py-5 px-5 border-r border-r-gray-900 h-screen fixed left-0 top-0">
      ...
      <button className="flex items-center gap-2 px-3 py-2 rounded-lg mb-2 transition-colors duration-300 w-full text-red-600 hover:bg-blue-300 hover:text-white cursor-pointer">
        <LogOut size={20} />
        <span>Logout</span>
      </button>
    </nav>
