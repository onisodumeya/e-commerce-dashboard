...
const AuthForm: React.FC<AuthFormProps> = ({ header, subHeader, children }) => {
  return (
    <div className="lg:w-1/3 w-full bg-gray-950/20 border border-white/60 backdrop-blur-xs text-white p-5 rounded-lg flex flex-col items-center px-5 md:px-10 gap-5">
